...
public class HealthCheckController {
    ...
    public ResponseEntity<ApiResponse<HealthCheck>> performHealthCheck(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success(healthCheck, "Health check completed. Risk Level: " + healthCheck.getRiskLevel()));
    }
    ...
    public ResponseEntity<ApiResponse<List<HealthCheck>>> getHealthChecksByPatient(
